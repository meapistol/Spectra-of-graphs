...
# Updates
Version 7 of the paper is now uploaded to arXiv and includes the classification of isospectral sets with 8 and 9 vertices and discoveries made using these sets. GraphRoots.nb is updated to supports vs7 of the paper. In particular it now includes two different notebooks to compute secular determinants.
# Data
